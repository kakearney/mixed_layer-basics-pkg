...
[bio, names, Biovars] = wcenemuroflexsetup(In, Grd);
...
odefun = @(t,b,P) wcenemuroflexode(t, b, P); % specify 3 rather than 4 inputs
...
% PON and Opal sink.  User can also set other things to sink via settle
% input(s).

biosettle = zeros(1, Biovars.ngroup);
biosettle(Biovars.nemidx) = -Biovars.settle;
