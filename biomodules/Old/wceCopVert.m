function varargout = wceCopVert(action, varargin)
%WCE Water column ecosystem biological module (with diapause)
%
...
%
% This version includes copepod vertical movement to represent diapause.
%
...
dn = datenum(Biovars.syear,1,1) + t./86400;
dv = datevec(dn);

if dv(2) >= 5 && dv(2) < 9 % May-Sep: at 0-150 m
    wsink(z < -100, Biovars.idx.zl) = 80./86400;
else % Rest of year, stay below 400 m
    wsink(z > -400, Biovars.idx.zl) = -80./86400;
    wsink(z < -450, Biovars.idx.zl) = 80./86400;
end
